...
class Config:
    def __init__(self, file_path) -> None:
        with open(file_path, "r") as f:
            ...
            self.kps = config["kps"]
            self.kds = config["kds"]
            self.kps_waist1 = config["kps_waist1"]
            self.kds_waist1 = config["kds_waist1"]
            # self.default_angles = np.array(config["default_angles"], dtype=np.float32)
            self.default_waist1_angles = np.array(config["default_waist1_angles"], dtype=np.float32)
            self.default_waist3_angles = np.array(config["default_waist3_angles"], dtype=np.float32)
            ...
            self.default_start_angles = config["default_start_angles"]
